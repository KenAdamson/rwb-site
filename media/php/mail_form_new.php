...
// OPTIONS - PLEASE CONFIGURE THESE BEFORE USE!
	...
	$yourEmail = "conductor@riverwindsband.org"; // the email address you wish to receive these mails through
	$bccEmail = "marcuslehto@frontier.com"; // the email address you wish to bcc these mails through
	$yourWebsite = "http://www.riverwindsband.org"; // the name of your website
	$thanksPage = 'http://www.riverwindsband.org/contactthankyou.html'; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
